...
extern class AL {
	...
	public static function alGenEffects    (n : Int, effects : hl.Bytes) : Void;
	public static function alDeleteEffects (n : Int, effects : hl.Bytes) : Void;
	public static function alIsEffect      (effect : Effect) : Bool;
	public static function alEffecti       (effect : Effect, param : Int, iValue    : Int)      : Void;
	public static function alEffectiv      (effect : Effect, param : Int, piValues  : hl.Bytes) : Void;
	public static function alEffectf       (effect : Effect, param : Int, flValue   : hl.F32)   : Void;
	public static function alEffectfv      (effect : Effect, param : Int, pflValues : hl.Bytes) : Void;
	public static function alGetEffecti    (effect : Effect, param : Int)                       : Int;
	public static function alGetEffectiv   (effect : Effect, param : Int, piValues  : hl.Bytes) : Void;
	public static function alGetEffectf    (effect : Effect, param : Int)                       : hl.F32;
	public static function alGetEffectfv   (effect : Effect, param : Int, pflValues : hl.Bytes) : Void;

	public static function alGenFilters    (n : Int, filters : hl.Bytes) : Void;
	public static function alDeleteFilters (n : Int, filters : hl.Bytes) : Void;
	public static function alIsFilter      (filter : Filter) : Bool;
	public static function alFilteri       (filter : Filter, param : Int, iValue    : Int)      : Void;
	public static function alFilteriv      (filter : Filter, param : Int, piValues  : hl.Bytes) : Void;
	public static function alFilterf       (filter : Filter, param : Int, flValue   : hl.F32)   : Void;
	public static function alFilterfv      (filter : Filter, param : Int, pflValues : hl.Bytes) : Void;
	public static function alGetFilteri    (filter : Filter, param : Int)                       : Int;
	public static function alGetFilteriv   (filter : Filter, param : Int, piValues  : hl.Bytes) : Void;
	public static function alGetFilterf    (filter : Filter, param : Int)                       : hl.F32;
	public static function alGetFilterfv   (filter : Filter, param : Int, pflValues : hl.Bytes) : Void;

	public static function alGenAuxiliaryEffectSlots    (n : Int, effectslots : hl.Bytes) : Void;
	public static function alDeleteAuxiliaryEffectSlots (n : Int, effectslots : hl.Bytes) : Void;
	public static function alIsAuxiliaryEffectSlot      (effectslot : EffectSlot) : Bool;
	public static function alAuxiliaryEffectSloti       (effectslot : EffectSlot, param : Int, iValue    : Int)      : Void;
	public static function alAuxiliaryEffectSlotiv      (effectslot : EffectSlot, param : Int, piValues  : hl.Bytes) : Void;
	public static function alAuxiliaryEffectSlotf       (effectslot : EffectSlot, param : Int, flValue   : hl.F32)   : Void;
	public static function alAuxiliaryEffectSlotfv      (effectslot : EffectSlot, param : Int, pflValues : hl.Bytes) : Void;
	public static function alGetAuxiliaryEffectSloti    (effectslot : EffectSlot, param : Int) : Int;
	public static function alGetAuxiliaryEffectSlotiv   (effectslot : EffectSlot, param : Int, piValues  : hl.Bytes)  : Void;
	public static function alGetAuxiliaryEffectSlotf    (effectslot : EffectSlot, param : Int) : hl.F32;
	public static function alGetAuxiliaryEffectSlotfv   (effectslot : EffectSlot, param : Int, pflValues : hl.Bytes)  : Void;
}